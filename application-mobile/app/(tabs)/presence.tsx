...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, ActivityIndicator, StatusBar, Platform, RefreshControl, Image } from 'react-native';
...
const TRANSLATIONS = {
  ...
  en: {
    ...
    subtitle: 'Track attendance and absences',
    today: 'Today',
    all: 'All Sessions',
    markCall: 'Take Attendance',
